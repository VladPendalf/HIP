...
# R^2 = 0.08617
# Наивысшую зарплату получают мужчины , без высшего образования, работающие не в городе, и перерабатывающие

model_subset = lm(data = data8,salary~age + sex + r_educ + status1 + dur + wed + wed2 + wed3)
summary(model_subset)
# R^2 = 0.06726
# Наивысшую зарплату получают мужчины, без высшего образования и перерабатывающие
